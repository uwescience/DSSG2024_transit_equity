...
def get_summary_census_block_counts_df(gdf_block_group_counts: gpd.GeoDataFrame,
    ...
    summary = [f'Total Blocks: {gdf_block_group_counts.shape[0]}']
    summary.append(f'Average {transaction_label}s per Block: {gdf_block_group_counts[summary_column].mean()}')
