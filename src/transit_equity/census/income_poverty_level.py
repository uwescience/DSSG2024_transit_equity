...
def get_population_in_income_level_range(income_poverty_level_row: pd.Series, 
    ...
    >>> from transit_equity.census.income_poverty_level import get_population_in_income_level_range
    ...
    >>> get_population_in_income_level_range(income_poverty_level_row, 0, 2.0)
    60
    """
    population = 0
